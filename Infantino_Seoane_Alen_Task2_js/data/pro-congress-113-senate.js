...
A- POR CONSOLA: MOSTRAR UN LISTADO DE TODOS LOS MIEMROS DE LA CAMARA CORRESPONDIENTE
B- POR CONSOLA: MOSTRAR UN LISTADO (O TABLA) DE TODOS LOS ESTADOS, ORDENADOS ALFABETICAMENTE Y SIN REPETIR
C- GENERAR UNA FUNCION QUE ME PERMITA MOSTRAR SOLO LOS MIEMBROS DE UN DETERMINADO PARTIDO
D- GENERAR UNA FUNCION QUE ME PERMITA MOSTRAR SOLO LOS MIEMBROS DE UN DETERMINADO ESTADO

*/

// ejercicio A

//for(let i=0 ; i < data.results[0].members.lenght ; i++){
//console.log(data.results[0].members[i])
//}

// data.results[0].members.forEach(member => console.log(member.first_name + " " + member.last_name))
...
// data.results[0].members.forEach((member) => { if (estados.indexOf(member.state) == -1){
...
// function filtrarPorPartido(nombre,partido){
//   let result = nombre.filter( (miembro) => {
//     if (miembro.state == partido){
//       return true
//     }
//     else {
//       return false
...
// function filtrarPorPartido(nombre,estado){
//   let result = nombre.filter( (miembro) => {
//     if (miembro.party == estado){
//       return true
//     }
//     else {
//       return false
